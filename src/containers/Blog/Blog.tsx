...
const Blog = () => {
    let url_img : string; // declaracion de variable para setear la url de la imagen del post
    ...
    return(
        <div className={styles.blog} id="blog">
                <PageTitle title="LATEST NEWS" description="Latest news about technology, entertainment, and science."/>
                {news === undefined
