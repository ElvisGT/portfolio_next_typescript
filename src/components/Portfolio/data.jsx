const data = [
    ...
    },
    {
        ...
        description:'Proyecto donde utilicé mis conocimientos en React, hice uso de Redux para el flujo de la información y además utilicé una API Rest pública con datos falsos de práctica',
